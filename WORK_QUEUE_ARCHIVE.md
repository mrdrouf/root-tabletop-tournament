...
- [x] **Map buttons need a wipe warning: "This will reset the current map."** DONE 2026-09-06. All
      ...
      wipe_confirm_sq_v3 and reproduced: Luminari 53pt, cream #F7EED6 on a 4px black stroke,
      transparent 272x272, ink inside 240px. The existing one reads "This will / reset all /
      factions." on three lines at an 80px pitch; the maintainer's wording needs FOUR lines, so the
      pitch tightens to 66px. Published as wipe_confirm_map_dc558096.png and registered in the BOARD's
      CustomUIAssets as WipeConfirmMapArt.
