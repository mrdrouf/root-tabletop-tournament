...
-- duplicate meeples wrapped around one useful deck. Only the deck comes along, at x 34.3, continuing
-- the row's 7.95 spacing; the button is gone and its slot on the tools row is free.
