...
-- This IS the real Crafted Improvements board (its exact art, only the title repainted to "Captains"),
-- at its exact scale (9.516764) with its exact 5 snap points copied from the game object -- so the snaps
-- are the game's own and land dead-on the 5 card slots. Put the 3 drafted captains in any of the slots.
RTT_CAPTAIN_BOARD_JSON = [==[{"Name":"Custom_Tile","Transform":{"posX":0.0,"posY":11.5,"posZ":0.0,"rotX":0.0,"rotY":0.0,"rotZ":0.0,"scaleX":9.516764,"scaleY":1.0,"scaleZ":9.516764},"Nickname":"Knaves Captains","Description":"","ColorDiffuse":{"r":1.0,"g":1.0,"b":1.0},"Locked":true,"Grid":true,"Snap":true,"IgnoreFoW":false,"MeasureMovement":false,"DragSelectable":true,"Autoraise":true,"Sticky":true,"Tooltip":true,"GridProjection":false,"HideWhenFaceDown":false,"Hands":false,"AttachedSnapPoints":[{"Position":{"x":0.00249,"y":0.19903,"z":-0.3043}},{"Position":{"x":0.00386,"y":0.20088,"z":-0.12854}},{"Position":{"x":-0.00409,"y":0.20145,"z":0.09181}},{"Position":{"x":-0.00684,"y":0.20134,"z":0.29284}},{"Position":{"x":0.00133,"y":0.20159,"z":0.51826}}],"CustomImage":{"ImageURL":"https://cdn.jsdelivr.net/gh/mrdrouf/root-tabletop-tournament@main/assets/labels/knaves_captains_v5.png","ImageSecondaryURL":"","ImageScalar":1.0,"WidthScale":0.0,"CustomTile":{"Type":0,"Thickness":0.1,"Stackable":false,"Stretch":true}}}]==]
