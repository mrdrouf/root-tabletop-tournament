...
RTT_VP_PANEL_DEPTH = 7.852103            -- (281 + 2*5) * 7.204507/267, the panel's own density
RTT_VP_PANEL_DZ  = 19.033528 / 2 + RTT_VP_PANEL_GAP + RTT_VP_PANEL_DEPTH / 2   -- 14.292816
...
function rttSpawnFaction(faction, cx, cz, flip, category, rotationY, opts)
  ...
  for _, v in ipairs(objects) do
    ...
    if isCraftBoard then
      local vpPos = rttKitPos(cx, cz, flip, rotationY,
                              { v.move_to[1], v.move_to[2], v.move_to[3] + RTT_VP_PANEL_DZ })
