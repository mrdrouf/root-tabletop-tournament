...
def render_plaque(big, small, out_path):
    """A square wooden plaque: big line over small line, dark wood + brass border,
    cream serif. Square so it isn't distorted in a square button."""
    W = H = 400
    ...
    ImageDraw.Draw(mask).rounded_rectangle([6, 6, W - 6, H - 6], radius=36, fill=255)
